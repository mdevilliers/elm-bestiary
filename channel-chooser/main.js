	...
	function (entitlement, location) {
		...
		if (_p1 === false) {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(location.address),
					_1: {ctor: '[]'}
				});
		} else {
			return A2(
	...
	function (entitlements, group) {
		...
		if (_p5.ctor === 'Nothing') {
			...
			if (_p6.ctor === '[]') {
				...
				return _elm_lang$core$Maybe$Just(x_);
			}
		}
	});
var _user$project$Main$replaceEntitlement = F2(
	function (entitlements, e) {
		var entitlements_ = A2(_user$project$Main$removeEntitlement, entitlements, e.group);
		return A2(_user$project$Main$addEntitlement, entitlements_, e);
	});
...
var _user$project$Main$channelDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$Main$Channel,
	A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'value', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'recorded_at', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'units', _elm_lang$core$Json_Decode$string));
...
var _user$project$Main$metadataDecoder = A4(
	...
	A2(_elm_lang$core$Json_Decode$field, 'location', _user$project$Main$locationDecoder),
	A2(_elm_lang$core$Json_Decode$field, 'owner', _user$project$Main$ownerDecoder));
	...
	function (msg, model) {
		...
		switch (_p9.ctor) {
			...
			case 'SetLocationVisibility':
				var entitlement_ = _elm_lang$core$Native_Utils.update(
					_p9._0,
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							currentEntitlement: A2(_user$project$Main$replaceEntitlement, model.currentEntitlement, entitlement_)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'MakeChannelAccessible':
				var channelEntitlement = _elm_lang$core$Native_Utils.update(
					_p9._1,
					{accessible: _p9._2});
				var entitlement_ = A2(_user$project$Main$replaceChannel, _p9._0, channelEntitlement);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Main$allGroupsForDropdown = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: _user$project$Main$GeneralPublic, _1: 0},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: _user$project$Main$EmergencyServices, _1: 1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: _user$project$Main$Academic, _1: 2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: _user$project$Main$Commercial, _1: 3},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: _user$project$Main$NonProfit, _1: 4},
					_1: {ctor: '[]'}
				}
			}
		}
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Main$accessibleStyle(channelEntitlement.discoverable),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(channelEntitlement.channel.id),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text(' : '),
							_1: {ctor: '[]'}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$hidden(!channelEntitlement.accessible),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$checked(channelEntitlement.discoverable),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													A3(_user$project$Main$MakeChannelDiscoverable, entitlement, channelEntitlement, !channelEntitlement.discoverable)),
												_1: {ctor: '[]'}
											}
										}
									},
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text('is discoverable'),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$hidden(!channelEntitlement.discoverable),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$checked(channelEntitlement.accessible),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(
																A3(_user$project$Main$MakeChannelAccessible, entitlement, channelEntitlement, !channelEntitlement.accessible)),
															_1: {ctor: '[]'}
														}
													}
												},
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text('is accessible'),
												_1: {ctor: '[]'}
											}
										}),
									_1: {ctor: '[]'}
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													_elm_lang$html$Html$input,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$checked(entitlement.locationVisbile),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(
																	A2(_user$project$Main$SetLocationVisibility, entitlement, !entitlement.locationVisbile)),
																_1: {ctor: '[]'}
															}
														}
													},
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html$text('disclose location'),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: A2(_user$project$Main$drawLocationView, entitlement, metadata.location),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _user$project$Main$drawChannelsView(entitlement),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Main$onSelect(_user$project$Main$AddEntitlement),
					_1: {ctor: '[]'}
				},
				A2(
					_elm_lang$core$List$map,
...
var _user$project$Main$drawEntitlementEditor = function (model) {
	...
	if (_p14.ctor === 'Nothing') {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Main$drawEntitlementSelector(true),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
					...
					_1: {
						ctor: '::',
						_0: _user$project$Main$drawGroupSelector(_p15),
						_1: {ctor: '[]'}
					}
				}
			});
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$drawEntitlementEditor(model),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$processLoad = function (result) {
	var _p16 = result;
	if (_p16.ctor === 'Ok') {
		return _user$project$Main$LoadingSuccess(_p16._0);
	} else {
		return _user$project$Main$LoadingFailed(_p16._0);
	}
};
var _user$project$Main$loadChannels = _user$project$Main$processLoad(
...
var _user$project$Main$init = {
	...
	_1: A2(
		...
		_elm_lang$core$Task$succeed(_user$project$Main$loadChannels))
};
